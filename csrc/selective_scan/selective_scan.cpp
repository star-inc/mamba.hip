...
selective_scan_fwd(const at::Tensor &u, const at::Tensor &delta,
    ...
    TORCH_CHECK(u.is_hip());
    TORCH_CHECK(delta.is_hip());
    TORCH_CHECK(A.is_hip());
    TORCH_CHECK(B.is_hip());
    TORCH_CHECK(C.is_hip());
